export const EN = {
  ...
  "console.articles.empty": "No Galley articles yet.",
  ...
  "console.home.context.empty": "Select a Markdown or Galley document to begin.",
  ...
  "console.home.recent.empty": "No recent Galley articles.",
  ...
  "console.unavailable.invalidDocument": "Invalid Galley document",
  ...
  "generation.error.requestTooLarge": "Galley: The provider rejected the request as too large. Reduce the article or context size.",
  "generation.error.network": "Galley: Could not reach the model provider. Check the Base URL and network.",
  "generation.error.invalidResponse": "Galley: The model returned an unreadable response. Try again or choose another compatible model.",
  "generation.error.skillLoading": "Galley: The model did not finish loading the Skill files. Try again or use a model with reliable tool calling.",
  ...
  ,"workbench.title": "Galley workbench"
  ...
  ,"workbench.error.editorInit": "Galley could not initialize this editor mode."
  ,"workbench.error.invalidEdit": "Galley rejected an unsafe or invalid body edit."
  ,"workbench.error.saveQuarantined": "Recovery is quarantined for this document. No file was overwritten."
  ,"workbench.error.saveAmbiguous": "Galley could not prove the save outcome. Recovery must complete before another save."
  ,"workbench.error.saveFailed": "Galley could not save this article."
...
export const ZH_CN: MessageResources = {
  ...
  "console.articles.empty": "暂无 Galley 文章。",
  ...
  "console.home.context.empty": "请选择 Markdown 或 Galley 文档开始。",
  ...
  "console.home.recent.empty": "暂无最近的 Galley 文章。",
  ...
  "console.unavailable.invalidDocument": "Galley 文档无效",
  ...
  "generation.error.requestTooLarge": "Galley：请求内容过大，请缩短文章或上下文。",
  "generation.error.network": "Galley：无法连接模型服务，请检查基础 URL 和网络。",
  "generation.error.invalidResponse": "Galley：模型返回了无法读取的响应，请重试或更换兼容模型。",
  "generation.error.skillLoading": "Galley：模型未能完成 Skill 文件加载，请重试或使用工具调用更稳定的模型。",
  ...
  ,"workbench.error.editorInit": "Galley 无法初始化此编辑模式。"
  ,"workbench.error.invalidEdit": "Galley 拒绝了不安全或无效的正文编辑。"
  ,"workbench.error.saveQuarantined": "此文档的恢复已隔离，未覆盖任何文件。"
  ,"workbench.error.saveAmbiguous": "Galley 无法确认保存结果；恢复完成前不能再次保存。"
  ,"workbench.error.saveFailed": "Galley 无法保存此文章。"
